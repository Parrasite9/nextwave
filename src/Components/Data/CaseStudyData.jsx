...
const CaseStudyData = [
	{
		...
		colors: {
			primary: '#0F4C81', // deep blue – enterprise/tech
			secondary: '#00B3B0', // bright teal – action/CTAs
			ctaButton: '#0F4C81',
		...
		name: 'Project Boost',
		shortDescription:
			'An enterprise-grade loyalty & rewards dashboard with automated points conversion, forecasting, and real‑time activity logging—built to turn unused points into revenue.',
		timeline: '4 weeks (MVP)',
		slug: generateSlug('Project Boost'),
		...
		problem: {
			...
			headerDetail:
				'Millions in customer points were nearing expiration with no systematic way to convert them into value. Teams relied on spreadsheets and manual lookups across disconnected systems—slow, inconsistent, and difficult to audit.',
			subheaders: [
				{
					subheader: 'Expiring Value, No Conversion Engine',
					subHeaderDetail:
						'Points were lost each month due to lack of timely identification and outreach.',
				},
				{
					subheader: 'Fragmented Data',
					subHeaderDetail:
						'Customer and transaction data lived in several sources with no single source of truth.',
				},
			],
		},
		...
		goal: {
			...
			headerDetail:
				'Build an automated, auditable system that identifies opportunities, executes redemptions, and reports results in real time—without adding headcount.',
			subheaders: [
				{
					subheader: 'Automate Opportunity Detection',
					subHeaderDetail:
						'Flag customers nearing expiration and estimate conversion value with forecasting.',
				},
				{
					subheader: 'One Dashboard, Role‑Based',
					subHeaderDetail:
						'Provide executives, managers, and staff with tailored views and permissions.',
				},
			],
		},
		...
		impact: {
			...
			headerDetail:
				'Projected to generate ~$250k in year‑one revenue at scale, while cutting manual effort and improving data trust.',
			subheaders: [
				{
					subheader: 'From Hours to Seconds',
					subHeaderDetail:
						'Recurring reporting and reconciliation automated; decisions made from live data.',
				},
				{
					subheader: 'Auditability & Accountability',
					subHeaderDetail:
						'Every action is logged (who/what/when), improving compliance and oversight.',
				},
			],
		},
		...
		ideation: {
			...
			headerDetail:
				'Designed as a modular platform: ingestion, rules engine, redemption workflow, notifications, reporting.',
			mediaType: 'image',
			...
			subheaders: [
				{
					...
					subHeaderDetail:
						'Projected monthly conversions to guide outreach and inventory planning.',
				},
				{
					subheader: 'Data Model for Scale',
					subHeaderDetail:
						'Built to add new sources and programs without rewrites.',
				},
			],
		},
		...
		testing: {
			...
			headerDetail:
				'Validated data reconciliation and redemption flows against historical samples; iterated UI for speed and clarity.',
			subheaders: [
				{
					subheader: 'Reconciliation Accuracy',
					subHeaderDetail:
						'Cross‑checked multi‑source records to ensure consistent totals and statuses.',
				},
			],
		},
		...
		final: {
			...
			headerDetail:
				'The dashboard ships with real‑time KPIs, opportunity queues, redemption workflows, and an immutable activity log.',
			mediaType: 'image',
			...
			subheaders: [
				{
					...
					subHeaderDetail:
						'Leaders see forecasts and outcomes; staff see prioritized actions.',
				},
				{
					subheader: 'Notifications & Escalations',
					subHeaderDetail:
						'Automatic reminders keep opportunities from expiring.',
				},
			],
		},
		...
		development: {
			...
			headerDetail:
				'Delivered an MVP in under 30 days (initial scope 60+), with secure authentication and centralized logging.',
			subheaders: [
				{
					subheader: 'Data Ingestion & Matching',
					subHeaderDetail:
						'Automated pipelines unify customer and transaction data, eliminating manual spreadsheet work.',
				},
				{
					subheader: 'Observability',
					subHeaderDetail:
						'Real‑time logs and metrics for fast troubleshooting and confidence.',
				},
			],
		},
		...
		future: {
			...
			headerDetail:
				'Next steps include per‑segment offers, A/B outreach tests, and deeper attribution to revenue.',
			subheaders: [],
		},
	},
