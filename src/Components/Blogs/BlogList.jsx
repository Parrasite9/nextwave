...
const BlogList = () => {
    ...
    return (
      <div className="px-8">
        ...
        {blogs.map((blog) => (
          <div key={blog.id} className="blog-preview flex flex-col justify-between border-4 p-2 cursor-pointer hover:shadow-lg hover:shadow-gray-500/50 transition-shadow duration-200 card-bg rounded-lg shadow-md hover:shadow-lg">
            <h2 className="font-bold text-lg font-bold text-soft-navy mb-2 md:text-xl lg:text-2xl">{blog.title}</h2>
