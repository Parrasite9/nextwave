        ...
        <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28">
            <div className="container">
                <div className="mb-8 w-full max-w-lg lg:mb-20">
                    <p className="mb-3 font-semibold md:mb-4">Professional Web Services Tailored to Your Needs</p>
                    <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">Pricing plan</h2>
                ...
                <div>
                    ...
                    <div className="flex items-start justify-between">
                        <div>
                        <h4 className="mb-2 text-xl font-bold md:text-2xl">Basic plan</h4>
                        <p>Lorem ipsum dolor sit amet</p>
                        </div>
                        <h5 className="justify-self-end text-6xl font-bold md:text-9xl lg:text-10xl">
                        $19<span className="text-2xl font-bold md:text-3xl md:leading-[1.3] lg:text-4xl"
                            >/mo</span
                        >
                        </h5>
                    </div>
