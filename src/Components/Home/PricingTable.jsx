...
// 											Perfect for launching a simple,
...
// 									Ideal for a 3-section landing page and
// 									essential features.
// 								</p>
...
// 										</h3>
// 										<p className="text-gray-500">
// 											A comprehensive package for growing
// 											businesses.
// 										</p>
// 									</div>
// 								</div>
...
// 								</button>
// 								<p className="mt-4 text-sm text-gray-500">
// 									Ideal for businesses ready to expand their
// 									digital reach.
// 								</p>
// 								<ul className="mt-6 space-y-4">
// 									{/* List of features */}
...
// 										</h3>
// 										<p className="text-gray-500">
// 											Tailored for businesses with unique
// 											needs.
// 										</p>
// 									</div>
// 								</div>
...
// 								</button>
// 								<p className="mt-4 text-sm text-gray-500">
// 									Perfect for custom builds, e-commerce, and
// 									large projects.
// 								</p>
// 								<ul className="mt-6 space-y-4">
// 									{/* List of features */}
...
// 											unique business needs. Choose the
// 											services you want and leave the ones
// 											you don't.
// 										</p>
// 									</div>
// 								</div>
...
// 								</button>
// 								<p className="mt-4 text-sm text-gray-500">
// 									Build a package that's perfect for your
// 									business.
// 								</p>
// 								<ul className="mt-6 space-y-4">
...
// src/Components/Pricing/PricingCTASection.jsx
