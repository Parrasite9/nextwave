...
function Services() {
  return (
    <div className='services__container px-8'>
        ...
        <h2 className='subheader text-lg font-semiBold text-center my-4 md:text-2xl'>Our Services</h2>
        ...
        <div className="services__info grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="service">
                <div className="service__image__container pb-4">
                    <img className=' ' src="/images/services/design.svg" alt="design" />
                </div>
                <div className="service__text-container bg-lemon-chiffon rounded-xl p-2">
                    <h2 className='subheader text-lg font-semiBold pb-2'>Web Design</h2>
            ...
            <div className="service">
                <div className="service__image__container pb-4">
                    <img className=' ' src="/images/services/landingPage.svg" alt="development" />
                </div>
                <div className="service__text-container bg-lemon-chiffon rounded-xl p-2">
                    <h2 className='subheader text-lg font-semiBold pb-2'>Development</h2>
            ...
            {/* SEO SERVICE  */}
            <div className="service">
                <div className="service__image__container pb-4 flex justify-center items-center">
                    <img className='w-4/5 h-auto' src="/images/services/seo.svg" alt="SEO" />
                </div>
                <div className="service__text-container bg-lemon-chiffon rounded-xl p-2">
                    <h2 className='subheader text-lg font-semiBold pb-2'>SEO</h2>
            ...
            <div className="service">
                <div className="service__image__container pb-4">
                    <img className=' ' src="/images/services/support.svg" alt="support" />
                </div>
                <div className="service__text-container bg-lemon-chiffon rounded-xl p-2">
                    <h2 className='subheader text-lg font-semiBold pb-2'>Maintnance & Support</h2>
