			...
			<div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 py-16 md:px-8 lg:grid-cols-2 lg:py-24">
				...
				<div className="relative">
					...
					<div className="mt-8 flex flex-col items-center gap-3 sm:flex-row sm:items-start">
						...
						<Link
							to="/pricing"
							className="inline-flex items-center rounded-xl border border-gray-300 px-6 py-3 text-sm font-semibold text-gray-700 transition hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
						>
