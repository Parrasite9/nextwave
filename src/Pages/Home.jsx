...
function Home() {
  return (
    <div>
      <Helmet>
        <title>Web Design in Midland TX | Boost Revenue with NextWave</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="Web Design in Midland TX | Boost Revenue with NextWave" />
        <meta
        ...
        <meta property="og:url" content="https://nextwavewebstudio.com" />      
      </Helmet>
